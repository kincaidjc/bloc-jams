...
var createSongRow = function(songNumber, songName, songLength){
    ...
    var clickHandler = function(){
        ...
        if(currentlyPlayingSongNumber !== null){
            // Revert to song number for currently playing song beause user started playing new song
...
var nextSong = function(){
    ...
    // note that we're incrementing the index here.
    currentSongIndex++;
...
// #1    Store state of playing songs
